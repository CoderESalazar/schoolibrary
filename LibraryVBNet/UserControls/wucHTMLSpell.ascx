<%@ Control Language="VB" AutoEventWireup="false" CodeFile="wucHTMLSpell.ascx.vb"
    Inherits="UserControls_wucHTMLSpell" %>
<%@ Register Assembly="FreeTextBox" Namespace="FreeTextBoxControls" TagPrefix="FTB" %>
<link href="/Styles/Table.css" rel="stylesheet" type="text/css" media="all" />
...
<FTB:FreeTextBox ID="ftbHTMLEditor" runat="server" SupportFolder="~/ftb/" JavaScriptLocation="ExternalFile" AutoGenerateToolbarsFromString="false" >
</FTB:FreeTextBox>
