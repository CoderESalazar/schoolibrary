...
<table cellpadding="5px" cellspacing="5px">
    <tr>
        ...
        <td valign="top">
  <%
  Set rsThis = dbElrc.Execute(" SELECT guide_header_info_id, head_title, department_discipline_id FROM guide_headers_info WHERE department_discipline_id = " & iParentId & " ORDER BY display_order")
