...
rsNLMain.Open "SELECT * FROM elrc_cr_guides WHERE guide_id= " & replace(Request.QueryString("guide_id"),";",""), dbThisUniversity, adOpenForwardOnly, adLockReadOnly
%>
<HTML>
<HEAD>
...
<form action="default_action.asp" method="POST" id=form1 name=form1>
	<table border="0" cellspacing="1" cellpadding="1">
		...
		<tr valign="top">
			...
			<td><textarea name="guide_body" rows="8" cols="40"><%=rsNLMain("guide_body")%></textarea></td>
		</tr>
		<tr valign="top">
			<td align="right"></td>
