...
<form action="default_action_res.asp" method="POST" id="form1" name="form1">
	<table border="0" cellspacing="1" cellpadding="1">
		...
		<tr valign="top">
			<td>Link Title: <input type="text" name="resource_title" size="40" value="<%=rsDW("resource_title")%>" /></td>
		
		</tr>
		<tr valign="top">
			<td>URL Resource: <input type="text" name="url_resource" size="60" value="<%=rsDW("url_resource")%>" /></td>
		...
		<tr valign="top">
			<td>Display Order: <input type="text" name="display_order" size="1" value="<%=rsDW("display_order")%>" /></td>
